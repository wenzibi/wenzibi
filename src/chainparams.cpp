...
public:
    CMainParams() {
        ...
        genesis.nNonce   = 232745;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e8ee14c2a4ef21d6b66c0f0f4cf5a87be63a627648bda7c23dacafd389d"));
        assert(genesis.hashMerkleRoot == uint256("0x9f8d4de5ed8e716fa266d78286e1df137133a91f5107be443f8958761beabeb1"));
        ...
        vSeeds.push_back(CDNSSeedData("123.57.233.74", "123.57.233.74"));
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 166201;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000186936a5e29f90d4c2181715a014e451597a39920297539eaaaba4228d3c"));
...
public:
    CRegTestParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 18444;
        assert(hashGenesisBlock == uint256("0x35fc51eb6f51881c76dc6ffa1ba10342452676ab77fe236b86c2e92a93002748"));
